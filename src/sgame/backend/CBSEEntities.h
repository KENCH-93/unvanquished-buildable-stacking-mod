...
class HumanEntity: public Entity {
	public:
		/** Initialization parameters for HumanEntity. */
		struct Params {
			gentity_t* oldEnt;
			float Health_maxHealth;
			gclient_t* Client_clientData;
		...
		/** Default constructor of HumanEntity. */
		HumanEntity(Params params);

		/** Default destructor of HumanEntity. */
		virtual ~HumanEntity() = default;

		TeamComponent c_TeamComponent; /**< HumanEntity's TeamComponent instance. */
		HealthComponent c_HealthComponent; /**< HumanEntity's HealthComponent instance. */
		ClientComponent c_ClientComponent; /**< HumanEntity's ClientComponent instance. */
		ArmorComponent c_ArmorComponent; /**< HumanEntity's ArmorComponent instance. */
		KnockbackComponent c_KnockbackComponent; /**< HumanEntity's KnockbackComponent instance. */
		HumanClassComponent c_HumanClassComponent; /**< HumanEntity's HumanClassComponent instance. */

	private:
		/** HumanEntity's message handler vtable. */
		static const MessageHandler messageHandlers[];

		/** HumanEntity's component offset table. */
		static const int componentOffsets[];
};
...
/** A specific entity. */
class DumbMissileEntity: public Entity {
	public:
		/** Initialization parameters for DumbMissileEntity. */
		struct Params {
			gentity_t* oldEnt;
			const missileAttributes_t* Missile_attributes;
		};

		/** Default constructor of DumbMissileEntity. */
		DumbMissileEntity(Params params);

		/** Default destructor of DumbMissileEntity. */
		virtual ~DumbMissileEntity() = default;

		DeferredFreeingComponent c_DeferredFreeingComponent; /**< DumbMissileEntity's DeferredFreeingComponent instance. */
		ThinkingComponent c_ThinkingComponent; /**< DumbMissileEntity's ThinkingComponent instance. */
		MissileComponent c_MissileComponent; /**< DumbMissileEntity's MissileComponent instance. */

	private:
		/** DumbMissileEntity's message handler vtable. */
		static const MessageHandler messageHandlers[];

		/** DumbMissileEntity's component offset table. */
		static const int componentOffsets[];
};

/** A specific entity. */
class HiveMissileEntity: public Entity {
	public:
		/** Initialization parameters for HiveMissileEntity. */
		struct Params {
			gentity_t* oldEnt;
			const missileAttributes_t* Missile_attributes;
		};

		/** Default constructor of HiveMissileEntity. */
		HiveMissileEntity(Params params);

		/** Default destructor of HiveMissileEntity. */
		virtual ~HiveMissileEntity() = default;

		DeferredFreeingComponent c_DeferredFreeingComponent; /**< HiveMissileEntity's DeferredFreeingComponent instance. */
		ThinkingComponent c_ThinkingComponent; /**< HiveMissileEntity's ThinkingComponent instance. */
		MissileComponent c_MissileComponent; /**< HiveMissileEntity's MissileComponent instance. */
		HiveMissileComponent c_HiveMissileComponent; /**< HiveMissileEntity's HiveMissileComponent instance. */

	private:
		/** HiveMissileEntity's message handler vtable. */
		static const MessageHandler messageHandlers[];

		/** HiveMissileEntity's component offset table. */
		static const int componentOffsets[];
};

/** A specific entity. */
class RocketMissileEntity: public Entity {
	public:
		/** Initialization parameters for RocketMissileEntity. */
		struct Params {
			gentity_t* oldEnt;
			const missileAttributes_t* Missile_attributes;
		};

		/** Default constructor of RocketMissileEntity. */
		RocketMissileEntity(Params params);

		/** Default destructor of RocketMissileEntity. */
		virtual ~RocketMissileEntity() = default;

		DeferredFreeingComponent c_DeferredFreeingComponent; /**< RocketMissileEntity's DeferredFreeingComponent instance. */
		ThinkingComponent c_ThinkingComponent; /**< RocketMissileEntity's ThinkingComponent instance. */
		MissileComponent c_MissileComponent; /**< RocketMissileEntity's MissileComponent instance. */
		RocketMissileComponent c_RocketMissileComponent; /**< RocketMissileEntity's RocketMissileComponent instance. */

	private:
		/** RocketMissileEntity's message handler vtable. */
		static const MessageHandler messageHandlers[];

		/** RocketMissileEntity's component offset table. */
		static const int componentOffsets[];
};
