...
class RocketMissileComponent;
class HiveMissileComponent;
...
namespace detail {
	...
	template<> struct ComponentPriority<MissileComponent> {
		static const int value = 4;
	};

	template<> struct ComponentPriority<RocketMissileComponent> {
		static const int value = 5;
	};

	template<> struct ComponentPriority<HiveMissileComponent> {
...
class Entity {
	public:
		...
		bool MissileSteer(); /**< Sends the MissileSteer message to all interested components. */
...
/** Base class of MissileComponent. */
class MissileComponentBase {
	public:
		/**
		 * @brief MissileComponentBase constructor.
		 * @param entity The entity that owns this component.
		 * @param attributes An initialization parameter.
		 * @param r_ThinkingComponent A ThinkingComponent instance that this component depends on.
		 */
		MissileComponentBase(Entity& entity, const missileAttributes_t* attributes, ThinkingComponent& r_ThinkingComponent)
			: entity(entity), attributes(attributes), r_ThinkingComponent(r_ThinkingComponent){
			allSet.insert(reinterpret_cast<MissileComponent*>(this));
		}

		~MissileComponentBase() {
			allSet.erase(reinterpret_cast<MissileComponent*>(this));
		}
		...
		static AllComponents<MissileComponent> GetAll() {
			return {allSet};
		}

	protected:
		const missileAttributes_t* attributes; /**< An initialization parameter. */

	private:
		ThinkingComponent& r_ThinkingComponent; /**< A component of the owning entity that this component depends on. */

		static std::set<MissileComponent*> allSet;
};

/** Base class of RocketMissileComponent. */
class RocketMissileComponentBase {
	public:
		/**
		 * @brief RocketMissileComponentBase constructor.
		 * @param entity The entity that owns this component.
		 * @param r_MissileComponent A MissileComponent instance that this component depends on.
		 */
		RocketMissileComponentBase(Entity& entity, MissileComponent& r_MissileComponent)
			: entity(entity), r_MissileComponent(r_MissileComponent){
			allSet.insert(reinterpret_cast<RocketMissileComponent*>(this));
		}

		~RocketMissileComponentBase() {
			allSet.erase(reinterpret_cast<RocketMissileComponent*>(this));
		}

		/**
		 * @return A reference to the MissileComponent of the owning entity.
		 */
		MissileComponent& GetMissileComponent();
		const MissileComponent& GetMissileComponent() const;
		...
		static AllComponents<RocketMissileComponent> GetAll() {
			return {allSet};
		}
	...
	private:
		MissileComponent& r_MissileComponent; /**< A component of the owning entity that this component depends on. */

		static std::set<RocketMissileComponent*> allSet;
};

/** Base class of HiveMissileComponent. */
class HiveMissileComponentBase {
	public:
		/**
		 * @brief HiveMissileComponentBase constructor.
		 * @param entity The entity that owns this component.
		 * @param r_MissileComponent A MissileComponent instance that this component depends on.
		 */
		HiveMissileComponentBase(Entity& entity, MissileComponent& r_MissileComponent)
			: entity(entity), r_MissileComponent(r_MissileComponent){
			allSet.insert(reinterpret_cast<HiveMissileComponent*>(this));
		}

		~HiveMissileComponentBase() {
			allSet.erase(reinterpret_cast<HiveMissileComponent*>(this));
		}
		...
		static AllComponents<HiveMissileComponent> GetAll() {
			return {allSet};
		}
	...
	private:
		...
		static std::set<HiveMissileComponent*> allSet;
};
