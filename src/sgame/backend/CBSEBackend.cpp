...
bool Entity::MissileSteer() {
	return SendMessage(EntityMessage::MissileSteer, nullptr);
}
 ...
 * @return A reference to the ThinkingComponent of the owning entity.
 */
ThinkingComponent& MissileComponentBase::GetThinkingComponent() {
    return r_ThinkingComponent;
}
const ThinkingComponent& MissileComponentBase::GetThinkingComponent() const {
    return r_ThinkingComponent;
}
 ...
 * @return A reference to the DeferredFreeingComponent of the owning entity.
 */
DeferredFreeingComponent& MissileComponentBase::GetDeferredFreeingComponent() {
    return r_ThinkingComponent.GetDeferredFreeingComponent();
}
const DeferredFreeingComponent& MissileComponentBase::GetDeferredFreeingComponent() const {
    return r_ThinkingComponent.GetDeferredFreeingComponent();
}


std::set<MissileComponent*> MissileComponentBase::allSet;

/**
 * @return A reference to the MissileComponent of the owning entity.
 */
MissileComponent& RocketMissileComponentBase::GetMissileComponent() {
    return r_MissileComponent;
}
const MissileComponent& RocketMissileComponentBase::GetMissileComponent() const {
    return r_MissileComponent;
}
 ...
 * @return A reference to the ThinkingComponent of the owning entity.
 */
ThinkingComponent& RocketMissileComponentBase::GetThinkingComponent() {
    return r_MissileComponent.GetThinkingComponent();
}
const ThinkingComponent& RocketMissileComponentBase::GetThinkingComponent() const {
    return r_MissileComponent.GetThinkingComponent();
}
 ...
 * @return A reference to the DeferredFreeingComponent of the owning entity.
 */
DeferredFreeingComponent& RocketMissileComponentBase::GetDeferredFreeingComponent() {
    return r_MissileComponent.GetDeferredFreeingComponent();
}
const DeferredFreeingComponent& RocketMissileComponentBase::GetDeferredFreeingComponent() const {
    return r_MissileComponent.GetDeferredFreeingComponent();
}


std::set<RocketMissileComponent*> RocketMissileComponentBase::allSet;

/**
 * @return A reference to the MissileComponent of the owning entity.
 */
MissileComponent& HiveMissileComponentBase::GetMissileComponent() {
    return r_MissileComponent;
}
const MissileComponent& HiveMissileComponentBase::GetMissileComponent() const {
    return r_MissileComponent;
}
 ...
 * @return A reference to the ThinkingComponent of the owning entity.
 */
ThinkingComponent& HiveMissileComponentBase::GetThinkingComponent() {
    return r_MissileComponent.GetThinkingComponent();
}
const ThinkingComponent& HiveMissileComponentBase::GetThinkingComponent() const {
    return r_MissileComponent.GetThinkingComponent();
}
 ...
 * @return A reference to the DeferredFreeingComponent of the owning entity.
 */
DeferredFreeingComponent& HiveMissileComponentBase::GetDeferredFreeingComponent() {
    return r_MissileComponent.GetDeferredFreeingComponent();
}
const DeferredFreeingComponent& HiveMissileComponentBase::GetDeferredFreeingComponent() const {
    return r_MissileComponent.GetDeferredFreeingComponent();
}


std::set<HiveMissileComponent*> HiveMissileComponentBase::allSet;
...
// HumanEntity's component offset vtable.
const int HumanEntity::componentOffsets[] = {
	0,
	0,
	myoffsetof(HumanEntity, c_TeamComponent),
	0,
	0,
	0,
	0,
	myoffsetof(HumanEntity, c_HealthComponent),
	myoffsetof(HumanEntity, c_ClientComponent),
	myoffsetof(HumanEntity, c_ArmorComponent),
	myoffsetof(HumanEntity, c_KnockbackComponent),
	0,
	0,
	myoffsetof(HumanEntity, c_HumanClassComponent),
	0,
	0,
	0,
	0,
...
// HumanEntity's Heal message dispatcher.
void h_Human_Heal(Entity* _entity, const void* _data) {
	auto* entity = static_cast<HumanEntity*>(_entity);
	const auto* data = static_cast<const std::tuple<float, gentity_t*>*>(_data);
	entity->c_HealthComponent.HandleHeal(std::get<0>(*data), std::get<1>(*data));
}

// HumanEntity's ApplyDamageModifier message dispatcher.
void h_Human_ApplyDamageModifier(Entity* _entity, const void* _data) {
	auto* entity = static_cast<HumanEntity*>(_entity);
	const auto* data = static_cast<const std::tuple<float&, Util::optional<glm::vec3>, Util::optional<glm::vec3>, int, meansOfDeath_t>*>(_data);
	entity->c_ArmorComponent.HandleApplyDamageModifier(std::get<0>(*data), std::get<1>(*data), std::get<2>(*data), std::get<3>(*data), std::get<4>(*data));
}

// HumanEntity's PrepareNetCode message dispatcher.
void h_Human_PrepareNetCode(Entity* _entity, const void*) {
	auto* entity = static_cast<HumanEntity*>(_entity);
	entity->c_HealthComponent.HandlePrepareNetCode();
}

// HumanEntity's Damage message dispatcher.
void h_Human_Damage(Entity* _entity, const void* _data) {
	auto* entity = static_cast<HumanEntity*>(_entity);
	const auto* data = static_cast<const std::tuple<float, gentity_t*, Util::optional<glm::vec3>, Util::optional<glm::vec3>, int, meansOfDeath_t>*>(_data);
	entity->c_HealthComponent.HandleDamage(std::get<0>(*data), std::get<1>(*data), std::get<2>(*data), std::get<3>(*data), std::get<4>(*data), std::get<5>(*data));
	entity->c_KnockbackComponent.HandleDamage(std::get<0>(*data), std::get<1>(*data), std::get<2>(*data), std::get<3>(*data), std::get<4>(*data), std::get<5>(*data));
...
// HumanEntity's message dispatcher vtable.
const MessageHandler HumanEntity::messageHandlers[] = {
	h_Human_PrepareNetCode,
	nullptr,
	nullptr,
	nullptr,
	h_Human_Heal,
	...
	nullptr,
	nullptr,
	h_Human_ApplyDamageModifier,
	nullptr,
	nullptr,
};

// HumanEntity's constructor.
HumanEntity::HumanEntity(Params params)
	: Entity(messageHandlers, componentOffsets, params.oldEnt)
...
// DumbMissileEntity's component offset vtable.
const int DumbMissileEntity::componentOffsets[] = {
	myoffsetof(DumbMissileEntity, c_DeferredFreeingComponent),
	myoffsetof(DumbMissileEntity, c_ThinkingComponent),
	0,
	0,
	myoffsetof(DumbMissileEntity, c_MissileComponent),
	0,
	0,
	0,
	0,
...
// DumbMissileEntity's FreeAt message dispatcher.
void h_DumbMissile_FreeAt(Entity* _entity, const void* _data) {
	auto* entity = static_cast<DumbMissileEntity*>(_entity);
	const auto* data = static_cast<const std::tuple<int>*>(_data);
	entity->c_DeferredFreeingComponent.HandleFreeAt(std::get<0>(*data));
}

// DumbMissileEntity's message dispatcher vtable.
const MessageHandler DumbMissileEntity::messageHandlers[] = {
	nullptr,
	h_DumbMissile_FreeAt,
	nullptr,
	nullptr,
	nullptr,
	nullptr,
...
// DumbMissileEntity's constructor.
DumbMissileEntity::DumbMissileEntity(Params params)
	: Entity(messageHandlers, componentOffsets, params.oldEnt)
	, c_DeferredFreeingComponent(*this)
	, c_ThinkingComponent(*this, c_DeferredFreeingComponent)
	, c_MissileComponent(*this, params.Missile_attributes, c_ThinkingComponent)
{}

// HiveMissileEntity
// ---------

// HiveMissileEntity's component offset vtable.
const int HiveMissileEntity::componentOffsets[] = {
	myoffsetof(HiveMissileEntity, c_DeferredFreeingComponent),
	myoffsetof(HiveMissileEntity, c_ThinkingComponent),
	0,
	0,
	myoffsetof(HiveMissileEntity, c_MissileComponent),
	0,
	myoffsetof(HiveMissileEntity, c_HiveMissileComponent),
	0,
	0,
	0,
	0,
...
// HiveMissileEntity's MissileSteer message dispatcher.
void h_HiveMissile_MissileSteer(Entity* _entity, const void*) {
	auto* entity = static_cast<HiveMissileEntity*>(_entity);
	entity->c_HiveMissileComponent.HandleMissileSteer();
}

// HiveMissileEntity's FreeAt message dispatcher.
void h_HiveMissile_FreeAt(Entity* _entity, const void* _data) {
	auto* entity = static_cast<HiveMissileEntity*>(_entity);
	const auto* data = static_cast<const std::tuple<int>*>(_data);
	entity->c_DeferredFreeingComponent.HandleFreeAt(std::get<0>(*data));
}

// HiveMissileEntity's message dispatcher vtable.
const MessageHandler HiveMissileEntity::messageHandlers[] = {
	nullptr,
	h_HiveMissile_FreeAt,
	nullptr,
	nullptr,
	nullptr,
	nullptr,
	...
	nullptr,
	nullptr,
	h_HiveMissile_MissileSteer,
};

// HiveMissileEntity's constructor.
HiveMissileEntity::HiveMissileEntity(Params params)
	: Entity(messageHandlers, componentOffsets, params.oldEnt)
	, c_DeferredFreeingComponent(*this)
	, c_ThinkingComponent(*this, c_DeferredFreeingComponent)
	, c_MissileComponent(*this, params.Missile_attributes, c_ThinkingComponent)
	, c_HiveMissileComponent(*this, c_MissileComponent)
{}

// RocketMissileEntity
// ---------

// RocketMissileEntity's component offset vtable.
const int RocketMissileEntity::componentOffsets[] = {
	myoffsetof(RocketMissileEntity, c_DeferredFreeingComponent),
	myoffsetof(RocketMissileEntity, c_ThinkingComponent),
	0,
	0,
	myoffsetof(RocketMissileEntity, c_MissileComponent),
	myoffsetof(RocketMissileEntity, c_RocketMissileComponent),
	0,
	0,
	0,
	0,
...
// RocketMissileEntity's MissileSteer message dispatcher.
void h_RocketMissile_MissileSteer(Entity* _entity, const void*) {
	auto* entity = static_cast<RocketMissileEntity*>(_entity);
	entity->c_RocketMissileComponent.HandleMissileSteer();
}

// RocketMissileEntity's FreeAt message dispatcher.
void h_RocketMissile_FreeAt(Entity* _entity, const void* _data) {
	auto* entity = static_cast<RocketMissileEntity*>(_entity);
	const auto* data = static_cast<const std::tuple<int>*>(_data);
	entity->c_DeferredFreeingComponent.HandleFreeAt(std::get<0>(*data));
}

// RocketMissileEntity's message dispatcher vtable.
const MessageHandler RocketMissileEntity::messageHandlers[] = {
	nullptr,
	h_RocketMissile_FreeAt,
	nullptr,
	nullptr,
	nullptr,
	nullptr,
	...
	nullptr,
	nullptr,
	h_RocketMissile_MissileSteer,
};

// RocketMissileEntity's constructor.
RocketMissileEntity::RocketMissileEntity(Params params)
	: Entity(messageHandlers, componentOffsets, params.oldEnt)
	, c_DeferredFreeingComponent(*this)
	, c_ThinkingComponent(*this, c_DeferredFreeingComponent)
	, c_MissileComponent(*this, params.Missile_attributes, c_ThinkingComponent)
	, c_RocketMissileComponent(*this, c_MissileComponent)
{}
